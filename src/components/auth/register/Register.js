  ...
  return (
    <div className={RegisterCSS.wrapper}>
      <div className={RegisterCSS.container}>
        ...
        <Label text={message ? message.error.message : <>&nbsp;</>} style={RegisterCSS.credentials} />
        <form className={RegisterCSS.form}>
          <div className={RegisterCSS.hor_row}>
            <div className={RegisterCSS.half_column}>
              <Label style={RegisterCSS.input_label} text="First name" required={true} errorMessage={errors.name} />
              <Input
                type="text"
                name="name"
            ...
            <div className={RegisterCSS.half_column}>
              <Label style={RegisterCSS.input_label} text="Last name" required={true} errorMessage={errors.surname} />
              <Input
                type="text"
                name="surname"
          ...
          <div className={RegisterCSS.row}>
            <Label style={RegisterCSS.input_label} text="Email" required={true} errorMessage={errors.email} />
            <Input
              type="text"
              name="email"
              placeholder="Email"
          ...
          <div className={RegisterCSS.row}>
            <Label style={RegisterCSS.input_label} text="Password" required={true} errorMessage={errors.password} />
            <Input
              type="password"
              name="password"
          ...
          <div className={`${RegisterCSS.row} ${RegisterCSS.margin25}`}>
            <Button text="Register" onClick={handleCredentialsClick} style={registerBtnStyle} />
          </div>
        </form>
      </div>
    </div>
