...
const CreateNoteTab = (props) => {
  ...
  const project = projectHooks.useSingleProject(location.pathname.split("/")[3]);
          ...
          <div className={CreateNoteTabCSS.layout}>
            <div>
              <div className={CreateNoteTabCSS.input_label}>
                <span className={CreateNoteTabCSS.input_title}>Title</span>
                <Input placeholder="Note Title" type="text" name="title" onChange={handleDataChange}></Input>
              </div>
              <div className={CreateNoteTabCSS.input_label}>
              ...
              <div className={CreateNoteTabCSS.input_label_two}>
                <span className={CreateNoteTabCSS.input_title}>Category</span>
                <Select
