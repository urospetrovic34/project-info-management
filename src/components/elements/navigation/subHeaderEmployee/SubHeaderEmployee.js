        ...
        <div className={SubHeaderEmployeeCSS.container}>
            <div className={SubHeaderEmployeeCSS.logo_container}>
                ...
                <div>
                    ...
                    <p className={SubHeaderEmployeeCSS.paragraph}>The New Alpha is a long running project. <br></br> We're creating sales pages for the clinets's business, <br /> creating blog posts, and managing the Shopify <br /> store </p>
                </div>
            </div>
