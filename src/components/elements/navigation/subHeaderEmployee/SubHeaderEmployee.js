  ...
  return (
    <div className={SubHeaderEmployeeCSS.container}>
      <div className={SubHeaderEmployeeCSS.logo_container}>
        <img src={logoData ? logoData.attributes.url : logo} alt="logo" className={SubHeaderEmployeeCSS.logo} />
        <div className={SubHeaderEmployeeCSS.text}>
          <h2 className={SubHeaderEmployeeCSS.title}>{props.project.data?.data.attributes.name}</h2>
          <p className={SubHeaderEmployeeCSS.paragraph}>{props.project.data?.data.attributes.description}</p>
        </div>
      </div>
      <div className={SubHeaderEmployeeCSS.info}>
        <div>
          <div className={SubHeaderEmployeeCSS.project_manager}>
            <h4 className={SubHeaderEmployeeCSS.headInfo}>Start Date</h4>
            <p>
        ...
        <div>
          <div className={SubHeaderEmployeeCSS.project_manager}>
            <h4 className={SubHeaderEmployeeCSS.headInfo}>Project Manager</h4>
            <img src={props.projectManagerAvatar} alt="logo" className={SubHeaderEmployeeCSS.profile_picture} />
          </div>
        </div>
        <div>
          <div className={SubHeaderEmployeeCSS.employees}>
            <div>
              <h4 className={SubHeaderEmployeeCSS.headInfo}>Employees</h4>
              <div className={SubHeaderEmployeeCSS.avatarEmployeeContainer}>
                {props.project.data?.data.attributes.employees.data
                  ?.filter((employee) => employee.id !== props.projectManagerId)
                  .map((employee) => (
                    <img
                      key={employee.id}
                      src={employee.attributes.avatar.data?.attributes.url || logo}
                      alt="logo"
            ...
            <div>
              <div className={SubHeaderEmployeeCSS.more}>
                +{props.project.data?.data.attributes.employees.data?.length - 3} more
              </div>
            </div>
          </div>
        </div>
