      ...
      <div className={EditAccountPageCSS.container}>
        <div className={EditAccountPageCSS.section_one}>
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${credentials.image ? credentials.image : Avatar})`,
            }}
            onClick={handleFileClick}
            onMouseOver={() => setCamera(true)}
            onMouseLeave={() => setCamera(false)}
          >
            {camera && <AiOutlineCamera className={EditAccountPageCSS.camera_thumb} />}
          </div>
          <div>
            <FileButton
              avatar={true}
        ...
        <div className={EditAccountPageCSS.section_two}>
          <div className={EditAccountPageCSS.acc_informations}>
            <div className={EditAccountPageCSS.row}>
              <Label style={EditAccountPageCSS.title_label} text="Account Settings" />
            </div>
            <div className={EditAccountPageCSS.row}>
              <Label style={EditAccountPageCSS.input_label} text="First Name" />
              <Input
            ...
            <div>
              <Label style={EditAccountPageCSS.input_label} text="Last Name" />
              <Input
            ...
            <div>
              <Label style={EditAccountPageCSS.input_label} text="Email" />
              <Input
            ...
            <div>
              <Label style={EditAccountPageCSS.input_label} text="Description" />
              <Input
